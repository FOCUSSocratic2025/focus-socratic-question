#!/usr/bin/env python3
"""
instruction_tune_llama3_instruct_lora.py

Instruction-tune Meta-Llama-3-8B-Instruct with LoRA adapters.
...
HUB_REPO_ID   = "username/llama3-chat-lora"
...
def make_prompt(ins: str, inp: str, out: str) -> str:
    return (
        "Instruction:\n"
...
def main():
    ...
    training_args = TrainingArguments(
        ...
        hub_strategy="end",
        hub_token=token,
        logging_dir="./llama3_chat_lora/logs",
    )
